...
@SourceType(value = "MarketoARP", label = "Marketo",uiConfig = "marketo-layout.json")
public class MarketoConf extends AbstractArpConf<MarketoConf> {
  private static final String ARP_FILENAME = "arp/implementation/marketo-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.marketo.MarketoDriver";
